...
$(document).ready(function() {
	...
	document.getElementById('upload-image-button').onclick = function() {
		...
		reader.readAsDataURL($('#upload-image')[0].files[0]);
	};
...
function rasterizesvg(){
	...
	setTimeout(function() {
		canvas.getObjects().map(function(o) {
			var old_top = o.getTop();
			var old_left = o.getLeft();
			var new_top = old_top + 115;
			var new_left = old_left + 165;
			o.set({'left': new_left, 'top': new_top});
			o.setCoords();
		});

		canvas.backgroundColor = $('#shirtDiv').css('background-color');
		canvas.renderAll();
		canvas.setWidth(530);
